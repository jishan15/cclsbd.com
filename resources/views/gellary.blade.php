...
<!-- Mirrored from www.exotheme.com/gocargo-recharge/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Sep 2022 07:46:38 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div id="content" class="no-top no-bottom">
            ...
            <div id="gallery" class="gallery full-gallery ex-gallery zoom-gallery col-3">
                ...
                <div class="item illustration">
                    <div class="picframe">
                        <a href="img/gallery/pic-1.jpg">
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-1.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item mobile website">
                    <div class="picframe">
                        <a href="img/gallery/pic-2.jpg">
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-2.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item website mobile">
                    <div class="picframe">
                        <a href="img/gallery/pic-3.jpg">
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-3.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item illustration photography">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-4.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-4.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item website photography mobile">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-5.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-5.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item illustration website">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-6.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-6.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item illustration photography">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-7.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-7.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item photography mobile">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-8.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-8.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item photography mobile">
                    <div class="picframe">
                        <a href="{{asset('frontend')}}/img/gallery/pic-9.jpg">
                            <span class="overlay"></span>
                            ...
                            <img src="{{asset('frontend')}}/img/gallery/pic-9.jpg" alt="" />
                        </a>
                    </div>
                </div>
                <!-- close gallery item -->
