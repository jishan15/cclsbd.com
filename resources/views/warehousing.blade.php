...
<body style="font-family: nobel;">
    ...
    <div id="wrapper">
        ...
        <!-- subheader begin -->
        <section id="subheader" class="page-service-5 no-bottom" data-stellar-background-ratio="0.5">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="container">
                <div class="row text-dark">
                    <div class="col-md-8">
                        ...
                        <h2>Warehousing Details</h2>
                        <div class="divider-deco"><span></span></div>
                        <p><strong><i>Build a strong, predictable supply chain backed by CML Consolidation & Logistics Services Ltd’s years of experience in international air freight shipping</i></strong></p>
                        <img src="{{asset('frontend')}}/img/services/warehousing/small-9.jpg" class="pull-left" alt=""><p>With the increase of trade in Bangladesh, warehouses are in high demand. We also have this important facility for our customers that not only allow them to store their cargo in a safe and secured environment, but also provide the luxury of responding to emergency demand and supply situations. Operations such as order consolidation, order assembly, product mixing and cross-docking that take place within the warehouse structure also add value to the overall logistics system and we do ensure necessary tools are in good shape and at hand at all times to perform these duties. Benefits we offer with this facility</p>
                        <p> Integrating Freight in the Transportation Planning Process and presents techniques and strategies for planning, programming, and implementing freight transportation projects and plans.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="icon-list arrow">
                                    ...
                                    <li>Full compliance with global standards to maintaining the facility​ </li>
                                    <li>Round the clock (24/7) staff​</li>
                                    <li>Closed-circuit monitoring at all times​</li>
                            ...
                            <div class="col-md-6">
                                ...
                                <p>As freight volumes continue to grow on the national transportation network, a skilled and knowledgeable workforce at all levels of transportation policy development and project level planning is crucial to improving the productivity, safety, and security of freight movement</p>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/warehousing/one.jpg" alt="" class="img-fluid" style="height: 170px; width: 100%;">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/warehousing/two.jpg" alt="" class="img-fluid" style="height: 170px; width: 100%;">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/warehousing/three.png" alt="" class="img-fluid" style="height: 170px; width: 100%;">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/warehousing/four.webp" alt="" class="img-fluid" style="height: 170px; width: 100%;">
                            </div>
                            <div class="clearfix"></div>
                        </div>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li class="active"><a href="{{ url('/warehousing')}}">Warehousing</a></li>
                                <li><a href="{{ url('/custom-brokerage')}}">Custom Brokerage</a></li>
                            </ul>
                        </div>
                    </div>
