            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <img src="{{asset('frontend')}}/img/services/ocean-freight/width-1.jpg" class="pull-right" alt=""><p><strong><i>We know how important choice and flexibility are to our customers, so we have nurtured long-standing relationships with a global network of agents at all origin ports over the course of 30 years.

                          
                            </i></strong></p>
                        <p class="text-dark">
                            They will work closely with you and your supplier to design a schedule with transit times to suit your requirements and arrange all the necessary documentation.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <ul class="text-dark">
                                    ...
                                    <li>NVOCC groupage shipments</li>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li ><a href="{{ url('/ocean-freight/sea-export')}}">Sea Export</a></li>
                                <li class="active"><a href="{{ url('/ocean-freight/sea-import')}}">Sea Import</a></li>
