...
<!-- Mirrored from www.exotheme.com/gocargo-recharge/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Sep 2022 07:46:17 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="crumb">
                                <ul>
                                    <li><a href="/">Home</a></li>
                                    <li class="active"><a href="{{ url('/work')}}">Our Work</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img src="{{asset('frontend')}}/img/new/work.jpeg" class="pull-right img-fluid" alt="" style="height: 200px; width:500px;"><p><strong><i>The process of forwarding freight is simple. Freight forwarding companies will negotiate with shipping providers to get the best possible price for the company making the shipment. They do this by comparing all the established commercial shipping routes and identifying the option that provides the most efficient service in terms of speed, cost, and reliability.</i></strong></p>
                        <p class="text-dark">
                            Most freight forwarding companies also offer additional resources on top of their regular services. For example, if required, many companies will help with delivery tracking and handling of dangerous goods.The forwarder will choose the best bid, add their fee and give a cost to the client. If the amount is accepted by the client, they must ready the product for transportation. Then the forwarding company will take the responsibility to transport from the origin to destination.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4>There are five steps in the freight forwarding process</h4>
                            ...
                            <div class="col-md-6">
                                <h4>Export haulage</h4>
                                <p class="text-dark">The freight forwarder transfers goods from your location to their warehouse.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Items checkpoint</h4>
                                <p class="text-dark"> The freight forwarder inspects the goods to ensure they were not damaged or lost during the export haulage phase.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Export customs clearance</h4>
                                <p class="text-dark">The freight forwarder obtains clearance for the transport of goods from the country of origin.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Import customs clearance</h4>
                                <p class="text-dark">Authorities in the destination country inspect the goods.</p>
                            </div>

                            <div class="col-md-6">
                                <h4>Destination arrival and handling</h4>
                                <p class="text-dark">The freight forwarder ensures all documents have been received and checks that all information is correct, then inspects and sorts the cargo.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 text-dark">
                                <p>Using freight forwarding services can be a very cost-effective choice for a business. If you are consistently shipping high volumes of products, the freight forwarding process will help lower the price of shipping by merging shipments across a whole range of different businesses.Letting a freight forwarding company take care of your shipments will also result in a more flexible shipping process. This is because they have the experience and resources to plan for any unexpected changes of plan. For example, it is common for deliveries to be delayed or rerouted. In these cases, your freight forwarder will have planned accordingly and will have protocols in place to rectify the issue. </p>
                            </div>
                        </div>
                        {{-- <div class="row">
                            <div class="col-lg-6">
