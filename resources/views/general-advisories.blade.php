    ...
    <div id="wrapper">
        ...
        <section id="subheader" class="page-news no-bottom">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1> GENERAL ADVISORIES</h1>
                            <div class="crumb">
                                <div>
                                    <ul>
                                        <li><a href="/">Home</a></li>
                                        <li class="active"><a href="{{ url('/general-advisories')}}">General Advisories</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div id="content">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <h2>General Advisories</h2>
                    </div>
                </div>
                <div class="row mt-3">
                    @foreach ($generalAdvisories as $generalAdvisories)
                    <div class="col-lg-4">
                        <div class="card"  style="height: 500px;">
                            <img src="{{asset('uploads/general/'.$generalAdvisories->image)}}" alt="" srcset="" style="height: 300px; width:100%;">
                            <div class="card-body">
                                <h4>{{$generalAdvisories->title}}</h4>
                                <p>{{$generalAdvisories->sub_title}}</p>
                            </div>
                            <div class="card-footer">
                                <p>{{$generalAdvisories->created_at}}</p>
                            </div>
                        </div>
                       </div>
                    @endforeach
