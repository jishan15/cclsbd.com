...
<body style="font-family: nobel;">
    ...
    <div id="wrapper">
        ...
        <!-- content begin -->
        <div id="content" class="no-padding text-dark">
                ...
                <div class="container-fullwidth ">
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            ...
                            <img src="{{asset('frontend')}}/img/collection/door/how-to-ship-to-amazon-FBA-from-China-image.png" class="img-fluid margintop20 marginbottom20 wow fadeInRight" alt="" style="height: 150px; width: 100%;"/>
                            <p>Door to Door Freight Services is a privately owned Freight. Door-to-door is the most comprehensive type of shipping service available.</p>
                            <a href="{{ url('/speacialized/door-delivery')}}" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            ...
                            <div class="tiny-border margintop10 marginbottom10 mb-2"></div>
                            <img src="{{asset('frontend')}}/img/collection/PHARMACEUTICAL/B2_PharmaLogisticsa.jpg" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".3s" alt="" style="height: 150px;  width: 100%;" />
                            <p>The pharmaceutical industry is complex and delicate, choosing the right Freight Forwarder can change the game</p>
                            <a href="{{url('/specialized/pharaceutical')}}" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            <h3>Sea Food</h3>
                            <div class="tiny-border margintop10 marginbottom10"></div>
                            <img src="{{asset('frontend')}}/img/collection/SEAFOOD/49677433377_e762684653_b.jpg" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".6s" alt=""  style="height: 150px;  width: 100%;" />
                            <p>The pharmaceutical industry is complex and delicate, choosing the right Freight Forwarder can change the game</p>
                            <a href="{{ url('/specailized/seafood')}}" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            <h3>DG Goods</h3>
                            <div class="tiny-border margintop10 marginbottom10 mb-2"></div>
                            <img src="{{asset('frontend')}}/img/collection/DG GOODS/2020032518021971948.jpg" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".9s" alt=""  style="height: 150px;" />
                            <p>Dangerous goods shipping is a very important task that must be taken seriously and done responsibly.</p>
                            <a href="{{ url('/specialized/dggoods')}}" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <!-- <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            <h3>Warehousing</h3>
                            <div class="tiny-border margintop10 marginbottom10"></div>
                            <img src="img/collection/warehousing/My project.png" class="img-fluid margintop20 marginbottom20 wow fadeInRight" alt=""  />
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            ...
                            <div class="tiny-border margintop10 marginbottom10"></div>
                            <img src="img/collection/Custom Brokerage/My project.png" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".3s" alt="" style="height: 130px;" />
                            <p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem</p>
                            <a href="service-details-1.html" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            ...
                            <div class="tiny-border margintop10 marginbottom10"></div>
                            <img src="img/services/7.png" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".6s" alt="" style="height: 130px;"/>
                            <p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem</p>
                            <a href="service-details-1.html" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div>
                    ...
                    <div class="box-service one-fourth">
                        <div class="bg-color-fx padding-5 text-center">
                            ...
                            <div class="tiny-border margintop10 marginbottom10"></div>
                            <img src="img/services/8.png" class="img-fluid margintop20 marginbottom20 wow fadeInRight" data-wow-delay=".9s" alt="" style="height: 130px;" />
                            <p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem</p>
                            <a href="service-details-1.html" class="btn-arrow hover-light"><span class="line"></span><span class="url">View Details</span></a>
                        </div>
                    </div> -->
