            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p class="text-dark">
                            At CML Consolidation & Logistics Services Ltd, our ocean freight forwarding products encourage the worldwide connections of in excess of 400 clients, across 130 nations. Any place you need your shipments to go, our innovative solutions structure the scaffold to your deals and acquisition markets. predictable, dependable sailings guarantee that your ocean freight shipments consistently arrive at your clients in a convenient way.
                        </p>
                        <p class="text-dark">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h4>Our services comprise of:</h4>
                                <ul class="text-dark">
                                    <li>Competitive pricing</li>
                                    <li>Wide network coverage</li>
                                    <li>NVOCC Operation</li>
                                    <li>Import Break Bulk</li>
                                    <li>GOH Handling</li>
                                    <li>Innovative and sophisticated systems and tools</li>
                                    <li>Door to Door delivery</li>
                                    <li>Inland Forwarding/Transportation</li>
                                    <li>Project Cargo Handling</li>
                                    <li>Frequent calling with a very desirable transit time</li>
                                    <li>Reliable consolidation at origin and deconsolidation at destination</li>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li class="active"><a href="{{ url('/ocean-freight')}}">Ocean Freight</a></li>
