...
<body style="font-family: nobel;">
    ...
    <div id="wrapper">
        ...
        <!-- subheader begin -->
        <section id="subheader" class="page-service-3 no-bottom" data-stellar-background-ratio="0.5">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="container">
                <div class="row text-dark">                    
                    <div class="col-md-8">
                        ...
                        <p><strong><i>At Cargo Express Trailers, we are focused on being the best rather than the biggest. Given our focus on quality above all else, it’s easy to see why Cargo Express makes the best value-driven, high-quality cargo utility trailers.</i></strong></p>
                        <p>
                            Cargo Express is the most reliable and affordable one-stop logistics solution provider based in North Carolina. Irrespective of your commodity, industry or markets, Cargo Express carries out conveyance of any kind of goods, including fragile items, safely using our state of the art infrastructure. By engaging our overseas shipping services, you can have peace of mind. To provide a true end-to-end experience, we offer our customers frequent transportation on all extensive trade lanes and inland services at affordable prices
                        </p>

                        <div class="divider"></div>
                        <img src="{{asset('frontend')}}/img/services/cargo-express/small-5.jpg" alt="" class="pull-left">
                        <h4>Auto Hauler</h4>
                        <p>We build every single Cargo Express Trailer to the highest standards so you can focus on the right set of wheels. From the smallest, entry-level auto hauler to the most heavy-duty, commercial-grade trailer, we have your precious cargo covered.</p>

                        <div class="divider"></div>
                        <img src="{{asset('frontend')}}/img/services/cargo-express/small-6.jpg" alt="" class="pull-left">
                        <h4>Off Road</h4>
                        <p>Cargo Express off-road trailers are constructed to provide an impressive amount of conveniences to your next excursion. We focus on our customers' needs so you can get on (or off) the trail..</p>

                        <div class="divider"></div>
                        <img src="{{asset('frontend')}}/img/services/cargo-express/small-7.jpg" alt="" class="pull-left">
                        <h4>Our Performance</h4>
                        <p>Our team comprises qualified staff who have undergone training and have years of experience in international container shipping in NC. Africa and the Middle East are our focus markets for international shipping services. With our professional shipping services, we promote a better global trade by transporting your valued goods across diverse industry verticals. From international courier services to roro service, we provide a range of specialized assistance.</p>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li><a href="service-details-1.html">Ocean Freight</a></li>{{url('/ocean-freight')}}
                                ...
                                <li><a href="{{ url('/consolidation')}}">Consolidation</a></li>
                                <li><a href="{{ url('/p.o.management')}}">P.O.Management</a></li>
                                <li  class="active"><a href="{{ url('/cargo-express')}}">Cargo Express</a></li>
