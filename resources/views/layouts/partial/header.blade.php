        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="html/index.html" class="logo-link">
                    ...
                    <img class="logo-dark logo-img" src="{{asset('backend')}}/images/Logo_CCLS-4.png" srcset="{{asset('backend')}}/images/logo-dark2x.png 2x" alt="logo-light">
                </a>
            </div>
            <!-- .nk-header-brand -->
            <div class="nk-header-news d-none d-xl-block">
                <div class="nk-news-list">
                    <a class="nk-news-item" href="#">
                        ...
                        <p >Welcome to CML Consolidation & Logistics Services LTD</p>
                    </a>
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{Auth::user()->company_name}}</div>
