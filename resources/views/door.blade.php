                        ...
                        <div class="col-md-12">
                            ...
                            <div class="crumb">
                                <ul>
                                    ...
                                    <li><a href="services.html">Specialized Services</a></li>
                                    <li>Door Delivery</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="single-carousel-arrow-nav">
                            <img src="{{asset('frontend')}}/img/collection/door/Air-Cargo-Service-From-China.png" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/door/how-to-ship-to-amazon-FBA-from-China-image.png" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/door/warehouse-management-as-stock-inventory-distribution-work-outline-concept-product-storage-transportation-occupation-203099806.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                        </div>

                        <div class="divider-single"></div>

                        <h2>Door Delivery Services Details</h2>
                        ...
                        <p class="text-dark">
                            Door to Door Freight Services is a privately owned Freight & Customs Brokerage. We specialise in international door to door shipping & freight services for small to medium sized companies who import and/or export freight. Whether you have FCL (full container load) or LCL (less than container load) cargo, at Door to Door Freight we take care of all your Customs import & export clearance requirements and logistics to ensure you enjoy hassle free shipping at a competitive price.
                        </p>
                        <h4>Effective Solutions</h4>
                        <p class="text-dark">Ship more transparently. Enjoy a service that eliminates intermediaries and makes shipment tracking much easier. Discover CML Consolidation & Logistics Services Ltd door-to-door services.</p>
                    </div>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li class="active"><a href="{{ url('/specialized/door-delivery')}}">Door Delivery</a></li>
                                <li><a href="{{ url('/specialized/Pharmaceutical')}}">Pharmaceutical</a></li>
