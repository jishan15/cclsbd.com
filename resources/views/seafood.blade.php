                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="single-carousel-arrow-nav">
                            <img src="{{asset('frontend')}}/img/collection/SEAFOOD/49677433377_e762684653_b.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/SEAFOOD/EsAl0SyXUAQN_Ov.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/SEAFOOD/VEHICULE-SEAFOODWAYS-1920.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                        </div>

                        <div class="divider-single"></div>

                        <h2>Sea Food Services Details</h2>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li><a href="{{ url('/specialized/door-delivery')}}">Door Delivery</a></li>
                                <li><a href="{{ url('/specialized/pharmaceutical')}}">Pharmaceutical</a></li>
                                <li  class="active"><a href="{{ url('/speacialized/sea-food')}}">Sea Food</a></li>
                                <li><a href="{{ url('/speacialized/dggoods')}}">DG Goods</a></li>
