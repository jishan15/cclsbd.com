...
<body style="font-family: nobel;">
    ...
    <div id="wrapper">
        ...
        <!-- subheader begin -->
        <section id="subheader" class="page-service-import no-bottom" data-stellar-background-ratio="0.5">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="crumb">
                                <ul>
                                    ...
                                    <li><a href="service-details-1.html"> Global Air Freight</a></li>
                                    <li>Air Import</li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <img src="{{asset('frontend')}}/img/collection/main/air.jpg" class="pull-right img-fluid" alt="" style="height: 300px; width:500px;"><p><strong><i>If you are importing to Bangladesh, AIT's customs brokerage team also offers a "Wheels Up" service, enabling your shipment to clear Bangladesh Customs while it's still in the air—speeding up transit times as much as a full day.</i></strong></p>
                        <p class="text-dark">
                        ...
                        <p>
                            Ready to partner with logistics experts who will work with you to design a plan that meets your vision, budget, and timeline? Request a quote or contact a representative to learn more or get started today.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img src="img/services/air-freight/wide-1.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="col-md-3">
                                <img src="img/services/air-freight/wide-2.jpg" alt="" class="img-fluid ">
                            </div>
                            <div class="col-md-3">
                                <img src="img/services/air-freight/wide-3.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="clearfix"></div>
                        </div>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li ><a href="{{ url('/air-freight/air-export')}}">Air Export</a></li>
                                <li class="active"><a href="{{ url('/air-freight/air-export')}}">Air Import</a></li>
