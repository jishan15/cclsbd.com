                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="single-carousel-arrow-nav">
                            <img src="{{asset('frontend')}}/img/collection/purchase order managment/a5.jpg" alt="" class="bg-image hover-zoomm img-fluid"  style="width: 800px; height: 380px;">
                            <img src="{{asset('frontend')}}/img/collection/purchase order managment/bigstock-Businessman-Manager-Using-Tabl-256679902-e1552510417779.jpg"  alt="" class="img-fluid bg-image hover-zoom" style="width: 800px; height: 380px;">
                            <img src="{{asset('frontend')}}/img/collection/purchase order managment/MrPeasy-Purchase-Order-Management-smaller1.webp" alt="" class="img-fluid bg-image hover-zoom" style="width: 800px; height: 380px;">
                        </div>

                        <div class="divider-single"></div>

                        <h2>P.O.Management Details</h2>
                        ...
                        <p>
                            Our Purchase Order Management system designed for shippers that usually source from one or more vendors and have multiple distribution centers or buyers. Customers with vendor compliance and communication issues will find value in PO Management, as the application offers dashboards and reports to monitor desired KPIs for each vendor. Benefits for shippers also include
                        </p>
                        ...
                        <ul>
                            <li> Decreased shipping costs</li>
                            <li>Better ability to meet production and delivery target dates</li>
                            <li>Advanced notifications on any Purchased Orders outside of shipment windows</li>
                            <li> Management of vendors for continuous improvement</li>
                            <li> Increased communication and less sourcing errors</li>
                            <li>Order consolidation and load planning</li>
                        </ul>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li><a href="{{ url('/consolidation')}}">Consolidation</a></li>
                                <li class="active"><a href="{{ url('/pomanagement')}}">P.O. Management</a></li>
