                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="single-carousel-arrow-nav">
                            <img src="{{asset('frontend')}}/img/collection/DG GOODS/dangerous-goods.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/DG GOODS/managing-dangerous-goods-1024x576.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                            <img src="{{asset('frontend')}}/img/collection/DG GOODS/2020032518021971948.jpg" alt="" class="img-fluid" style="height: 320px; width: 100%;">
                        </div>

                        <div class="divider-single"></div>

                        <h2>DG Goods Services Details</h2>
                        <div class="divider-deco"><span></span></div>
                        <p><strong><i>Dangerous goods shipping is a very important task that must be taken seriously and done responsibly.</i></strong></p>
                        <p class="text-dark">
                        ...
                        <p class="text-dark">To ensure consistency between all these regulatory systems, Bangladesh has developed mechanisms for the harmonization of hazard classification criteria and communication tools, and for transport conditions for all modes for transport.</p>
                    </div>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li class="active"><a href="{{ url('/specialized/dggoods')}}">DG Goods</a></li>
