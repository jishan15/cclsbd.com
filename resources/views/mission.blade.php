                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="crumb">
                                <ul>
                                    <li><a href="/">Home</a></li>
                                    <li class="active"><a href="{{ url('/mission')}}">Our Mission</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img src="{{asset('frontend')}}/img/new/mission.jpeg" class="pull-right img-fluid" alt="" style="height: 200px; width:500px;"><p><strong><i>Our mission is to give our customers a competitive advantage through superior transportation and freight forwarding services.We will meet and exceed our customer's expectation of service through prompt communications and quality information. With services as the base, technology as the tool and teamwork as the driving force,CCLS 
                           will ensure to meet and exceed the needs of its customer.</i></strong></p>
                        <p class="text-dark">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="text-dark">our mission statement is simplicity itself. To constantly exceed customer expectations by providing superior freight forwarding and global transportation solutions including air,
                                    ocean, and customs brokerage and logistics services.</p>
                            </div>

                            <div class="col-md-6">
                                {{-- <h4>Project Forwarding</h4> --}}
                                <p class="text-dark">Our team of professionals is totally committed to provide you a service that far exceeds your expectations.
                                    We put forward a tremendous extra effort everyday to give this level and quality of service and
                                    we are always striving to deliver the most efficient and effective solutions in the industry by utilizing state of the art technologies, 
                                   highly trained friendly and experience staff as well as a solid infrastructure.
                                   </p>
                            </div>

                            <div class="col-md-6">
                                {{-- <h4>Export Packing</h4> --}}
                                <p class="text-dark">Our most critical mission is to provide a competitive advantage to our clients by producing a reliable and
                                    personalized logistical support system that is consistently and dependable one hundred percent of the time all the time.</p>
                            </div>

                            <div class="col-md-6">
                                {{-- <h4>Contract Management</h4> --}}
                                <p class="text-dark">Honesty is the foundation of our company and our commitment to you.</p>
                            </div>
