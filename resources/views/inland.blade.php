        ...
        <section id="subheader" class="page-service-2 no-bottom" data-stellar-background-ratio="0.5">
            <div class="inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Inland Tracking</h1>
                            <div class="crumb">
                                <ul>
                                    <li><a href="/">Home</a></li>
                                    <li><a href="{{ url('/services')}}">Services</a></li>
                                    <li>Inland Tracking</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row text-dark">
                    <div class="col-md-8">
                        ...
                        <div class="single-carousel-arrow-nav">
                            <img src="{{asset('frontend')}}/img/collection/INLAND TRACKING/Inland-Container-Depot_Blog.jpg" alt="" class="bg-image hover-zoomm img-fluid"  style="width: 800px; height: 380px;">
                            <img src="{{asset('frontend')}}/img/collection/INLAND TRACKING/R.jpg"  alt="" class="img-fluid bg-image hover-zoom" style="width: 800px; height: 380px;">
                            <img src="{{asset('frontend')}}/img/collection/INLAND TRACKING/semi-trailers-534577_1280-1080x675.jpeg" alt="" class="img-fluid bg-image hover-zoom" style="width: 800px; height: 380px;">
                        </div>

                        <div class="divider-single"></div>

                        <h2>Inland Tracking Details</h2>
                        <div class="divider-deco"><span></span></div>
                        <p><strong><i>Adaptable, reliable, and coordinated arrangements in an always-changing environment</i></strong></p>
                        <p>
                            You are welcome to contact us and talk about your ideal inland transportation solution. Our inland transportation services offer port to port transportation which is only part of the story. When you also want inland transportation, we offer the resources you require. Our team of logistics professionals can offer you a wide variety of service solutions.
                        </p>
                        <h4>Your Business is Our Priority</h4>
                        <p>It doesn’t matter what you’re shipping, where your goods are going, or how quickly they need to get there, it’s our business to make your air freight business run smoothly.</p>
                        <h4>Our services comprise of:</h4>
                        <ul>
                            <li>Multiple modes of transport</li>
                            <li>An extensive network of transport providers</li>
                            <li>Constant monitoring and quality assurance</li>
                            <li>Timely pick-up and delivery</li>
                            <li>Time-saving and cost-efficient single point of contact</li>
                            <li>Services all over Bangladesh</li>
                            <li>Track-and-trace/Electronic Data Interface (EDI) visibility solutions</li>
                            <li>Supplier collections</li>
                            <li>Supply chain consultancy, including logistics network strategy and transport modeling</li>
                            <li>Warehousing facilities for storage of goods</li>
                        </ul>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                ...
                                <li><a href="{{ url('/warehousing')}}">Warehousing</a></li>
                                <li class="active"><a href="{{ url('/inland-tracking')}}">Inland Tracking</a></li>
                                <li><a href="{{ url('/custom-brokerage')}}">Custom Brokerage</a></li>
                            </ul>
                        </div> 
                    </div>
