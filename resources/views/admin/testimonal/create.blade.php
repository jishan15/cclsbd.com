...
<div class="card card-preview">
    <div class="card-inner">
        <div class="preview-block">
            <span class="preview-title-lg overline-title">Create Testimonal</span>
           <form action="{{ route('testimonal.store') }}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl form-control-outlined" id="outlined-normal" name="designation" >
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            ...
                            <textarea  cols="5" rows="5" type="Text" class="form-control form-control-xl form-control-outlined" id="outlined-normal" name="sub_title" ></textarea>
                ...
                {{-- <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            ...
                            <label class="form-label-outlined" for="outlined-right-icon">testimonal Month</label>
                        </div>
                    </div>
                </div> --}}
            </div>
            ...
            <div class="row gy-4">
               <div class="col-lg-12">
                <div class="form-group">
                    <label class="form-label" for="customFileLabel">testimonal File Upload</label>
                    <div class="form-control-wrap">
