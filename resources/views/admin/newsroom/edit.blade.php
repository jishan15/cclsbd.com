           ...
           <form action="{{route('newsroom.update',$newsroom->id)}}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="number" class="form-control form-control-xl form-control-outlined" id="outlined-normal" name="date" value="{{ $newsroom->date}}">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            ...
                            <input type="text" class="form-control form-control-xl form-control-outlined" id="outlined-right-icon" name="month" value="{{ $newsroom->month}}">
            ...
            <div class="row gy-4">
               <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <img src="{{asset('uploads/newsroom/'.$newsroom->image)}}" style="width: 140px; height:80px;" alt="" srcset="">
                    <div class="form-control-wrap">
