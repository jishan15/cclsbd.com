            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <img src="{{asset('frontend')}}/img/services/ocean-freight/width-1.jpg" class="pull-right" alt=""><p><strong><i>The CML Consolidation & Logistics Services Ltd. ocean product range offers an assortment of administrations to meet your sea gracefully chain needs. Every item has been created to fulfill your high guidelines for door-to-door transport services, and everything in the middle.</i></strong></p>
                        <p class="text-dark">
                            CML will guide your shipment every step of the way, keeping it on schedule from pickup to transit to final delivery. Exact steps may vary based on your shipment specifications, but sea exports with AIT generally follow a three-step process:
                        </p>
                        <p class="text-dark">
                            Whether it is less than a container load (LCL) or a full container load (FCL) or project cargo, is ready to ship on time and deliver on schedule. CML Consolidation & Logistics Services Ltd Branch Office situated at Agrabad, the commercial heart of Chittagong, only 3 km from the seaport. The Ocean freight division of CML Consolidation & Logistics Services Ltd is well equipped in terms of operation documentation, statistics and efficient staff with vast experience in the field of liner and NVOCC services.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/ocean/container-ship-sailing-transport-goods-import-export-internationally-worldwide_44353-3014.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/ocean/d77360_40e921da2e7c46978066603ca3928312_mv2.jpg" alt="" class="img-fluid ">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/ocean/Ha105475414994126ac3778fc39744b10n.webp" alt="" class="img-fluid">
                            </div>
                            <div class="col-md-3">
                                <img src="{{asset('frontend')}}/img/collection/ocean/Improved-logistics-flow-with-short-sea-shipping-solution-for-Bohus.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="text-dark">
                                    <ul>
                                        <li>Customer requests shipment</li>
                                        <li> Customer or shipper provides shipment information</li>
                                        <li> AIT books shipment with ocean carrier</li>
                                        <li>Pre-alert is sent to customer or destination agent</li>
                                        <li> CML arranges for pickup of freight</li>
                                    </ul>  
                            ...
                            <div class="col-md-6">
                                ...
                                <ul>
                                    <li>Shipment departs from origin port</li>
                                        <li>AIT tracks shipment until it arrives at destination port</li> 
                                       <li> Depending on type of shipment, consignee or destination agent arranges for customs clearance</li>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-dark">Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <ul class="text-dark">
                                    ...
                                    <li> Full container loade</li>
                                    <li>Less than container load</li>
                                    <li>Consolidation</li>
                                    <li> Project cargo</li>
                                    <li> Out-of-gauge and break-bulk cargo support</li>
                                    <li>Containerization with available reefer service</li>
                                    <li>Three easy steps to seamless ocean exports</li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <h4>Global Ocean Freight</h4>
					...
					<div class="col-md-4">
                        <div class="widget">
                            <ul class="side-nav">
                                <li><a href="{{ url('/ocean-freight')}}">All Global Ocean Freight Services</a></li>
                                <li class="active"><a href="{{ url('/ocean-freight/sea-export')}}">Sea Export</a></li>
                                <li><a href="{{ url('/ocean-freight/sea-import')}}">Sea Import</a></li>
